...
abstract class $AccountStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isRegistered, bool isDeleted});
}
...
class _$AccountStateImpl implements _AccountState {
  const _$AccountStateImpl({this.isRegistered = false, this.isDeleted = false});
  ...
  @override
  String toString() {
    return 'AccountState(isRegistered: $isRegistered, isDeleted: $isDeleted)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isRegistered, isDeleted);
...
abstract class _AccountState implements AccountState {
  const factory _AccountState({final bool isRegistered, final bool isDeleted}) =
      _$AccountStateImpl;
